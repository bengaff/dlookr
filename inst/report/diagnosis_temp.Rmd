...
var_descs <- get("var_descs", .dlookrEnv)
...
html_variable(reportData, var_descs = var_descs,
              theme = "$theme$", base_family = base_family)
...
html_missing(diagn_na_unique, var_descs = var_descs)
...
html_unique_cat(diagn_na_unique, thres_uniq_cat, var_descs = var_descs)
...
html_unique_num(diagn_na_unique, thres_uniq_num, var_descs = var_descs)
